...
// register Spa_and_Salon_Recent_Post widget
function spa_and_salon_register_recent_post_widget() {
    register_widget( 'Spa_and_Salon_Recent_Post' );
}
add_action( 'widgets_init', 'spa_and_salon_register_recent_post_widget' );

if( ! class_exists( 'Spa_and_Salon_Recent_Post' ) ): 
 /**
 * Adds Spa_and_Salon_Recent_Post widget.
 */
class Spa_and_Salon_Recent_Post extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'spa_and_salon_recent_post', // Base ID
            __( 'RARA: Recent Post', 'spa-and-salon' ), // Name
            array( 'description' => __( 'A Recent Post Widget', 'spa-and-salon' ), ) // Args
        );
    }
                    ...
                    <li>
                        <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php the_post_thumbnail( 'spa-and-salon-recent-post', array( 'itemprop' => 'image' ) );?>
                            </a>
                        <?php }?>
...
} // class Spa_and_Salon_Recent_Post 
