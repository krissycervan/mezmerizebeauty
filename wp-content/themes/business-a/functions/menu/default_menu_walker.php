<?php 
function business_a_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'business_a_page_menu_args' );

 
function business_a_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new business_a_walker_page_menu;
...
class business_a_walker_page_menu extends Walker_Page{
