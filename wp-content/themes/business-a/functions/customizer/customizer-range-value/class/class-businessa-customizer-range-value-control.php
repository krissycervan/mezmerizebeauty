 ...
 * @access public
 */
class Business_a_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Business_a_Customizer_Range_Value_Control constructor.
	 *
 ...
 */
function business_a_sanitize_range_value( $input ) {
	if ( Business_a_json( $input ) ) {
