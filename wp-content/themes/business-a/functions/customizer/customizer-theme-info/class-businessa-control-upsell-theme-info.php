<?php
$display_upsells = business_a_ready_for_upsells();
$define_classs = class_exists( 'WP_Customize_Control' ) && $display_upsells === true && ! class_exists( 'Business_a_Control_Upsell_Theme_Info' );
if ( $define_classs ) :
	/**
	 * Business_a_Control_Upsell_Theme_Info class.
	 */
	class Business_a_Control_Upsell_Theme_Info extends WP_Customize_Control {
		...
		/**
		 * business_a_Control_Upsell_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$this->pro_label   = esc_html__( 'PRO', 'business-a' );
			$manager->register_control_type( 'Business_a_Control_Upsell_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'business_a_upsell-style', get_template_directory_uri() . '/functions/customizer/customizer-theme-info/css/style.css');
		}
