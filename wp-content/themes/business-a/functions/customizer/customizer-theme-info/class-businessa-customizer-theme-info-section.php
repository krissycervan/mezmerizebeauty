...
$define_classs = class_exists( 'WP_Customize_Control' ) && $display_upsells === true && ! class_exists( 'Business_a_Customizer_Theme_Info_Section' );
if ( $define_classs ) :
	/**
	 * Class webdzier_Section_Upsell
	 */
	class Business_a_Customizer_Theme_Info_Section extends WP_Customize_Section {
		...
		/**
		 * Business_a_Customizer_Theme_Info_Section constructor.
		 */
