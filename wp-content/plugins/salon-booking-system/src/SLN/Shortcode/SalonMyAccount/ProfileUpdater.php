...
class SLN_Shortcode_SalonMyAccount_ProfileUpdater{
    ...
    public function dispatchForm(){
        if( !isset( $_POST['slnUpdateProfileNonceField'] ) || !wp_verify_nonce( $_POST['slnUpdateProfileNonceField'], 'slnUpdateProfileNonce') )             
            {
	...
	private function validate($values){
        $fields = SLN_Enum_CheckoutFields::toArray();
    ...
    {        
        $fields = array_keys(SLN_Enum_CheckoutFields::toArrayFull());
