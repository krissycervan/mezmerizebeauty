	...
	<tr style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #888;">
		<td height="55" valign="middle" bgcolor="#f2f2f2">
			<p style="margin-left: 49px; margin-right: 49px;">
				...
				$msg = sprintf(__("Dear %s,\nThis is a summary of bookings made last week:", 'salon-booking-system'), $name);
				$msg = nl2br($msg);
				echo $msg;
				?>
			</p>
	...
	<tr style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #888;">
		<td height="50" valign="middle" bgcolor="#f2f2f2">
			<p style="margin-left: 49px; margin-right: 49px;">
				<?php
				$msg = sprintf(
					__('<strong>%s reservations have been canceled</strong> from your customers.', 'salon-booking-system'),
					$stats['canceled']
				);
				$msg = nl2br($msg);
				echo $msg;
	...
	<tr style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #888;">
		<td height="50" valign="middle" bgcolor="#f2f2f2">
			<p style="margin-left: 49px; margin-right: 49px;">
				<?php
				$msg = sprintf(
					__("You had <strong>%s online customers</strong> last week.", 'salon-booking-system'),
					$stats['new_customers']
				);
				$msg = nl2br($msg);
				echo $msg;
